	...
	return (
		<div className={classes.wrapper}>
			<Switch>
				...
				//////// type_broker  */}
				<PropsRoute
					path='/broker/addPolicyDesign'
					component={AddPolicyDesign}
				/>

				<PropsRoute
					path='/c/broker/policies'
					component={Policies}
				/>
				<PropsRoute
					path='/c/broker/policyScheduleDesign'
					component={PolicyScheduleDesign}
				/>

				<PropsRoute
					path='/c/broker/profileSettings'
					component={Profile}
				/>
				<PropsRoute
					path='/c/broker/merchant'
					component={Merchant}
				/>
				<PropsRoute
					path='/c/broker/createMerchant'
				...
				<PropsRoute
					path='/c/broker/Insurance'
					component={Insurance}
				/>
				<PropsRoute
					path='/c/broker/createInsurance'
